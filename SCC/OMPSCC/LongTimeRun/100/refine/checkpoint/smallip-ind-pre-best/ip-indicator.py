...
def solve_indicator_half_linear(graph,edge_flag,initial=False,checkpoint_file=None):
    ...
    model.setParam('Heuristics', 0.8)  # 30% of the time spent on heuristics
    ...
    model.setParam('BarConvTol', 1e-2)  # More aggressive convergence tolerance
    ...
    model.setParam('MIPGap', 0.5)      # Allow a 10% optimality gap
