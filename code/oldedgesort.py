...
def dfs_remove_cycle_edges(graph):
    ...
    removed_weight = sum(w for u, vi,w in removed_edges)
...
def process_graph(file_path, output_file):
    ...
    # Step 3: Build a new directed acyclic graph (DAG) from the sorted edges
    ...
    print("Remained Edge Weight:", remained_weight, " Remained number of Edges=", new_G.number_of_edges())
    percentage_remained=remained_weight/total_weight*100
    print("Percentage of Remained Edges Weight:", percentage_remained)
