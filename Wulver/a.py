...
FileNameHead="IP"
output_file = f"{FileNameHead}-01readfile.txt"
print(output_file)
exit(0)
...
def process_graph(file_path):
    ...
    output_file = f"{FileNameHead}01readfile_{time_string}.txt"
    with open(output_file, 'w') as f:
    ...
    time_string = current_time.strftime("%Y%m%d_%H%M%S")
    # Create the file name using the formatted time string
    output_file = f"X02findcycle_{time_string}.txt"
    with open(output_file, 'w') as f:
    ...
    time_string = current_time.strftime("%Y%m%d_%H%M%S")
    # Create the file name using the formatted time string
    output_file = f"X03buildcyclegraph_{time_string}.txt"
    with open(output_file, 'w') as f:
    ...
    time_string = current_time.strftime("%Y%m%d_%H%M%S")
    # Create the file name using the formatted time string
    output_file = f"X04ipsolver{time_string}.txt"
    with open(output_file, 'w') as f:
    ...
    #removed_edges = solve_ip_for_minimum_feedback_arc_set(cycle_graph, cycles)
    #removed_edges = solve_ip_for_minimum_feedback_arc_set(cycle_graph, list(cycle_graph))
    ...
    time_string = current_time.strftime("%Y%m%d_%H%M%S")
    # Create the file name using the formatted time string
    output_file = f"X05constructdag{time_string}.txt"
    with open(output_file, 'w') as f:
    ...
    time_string = current_time.strftime("%Y%m%d_%H%M%S")
    # Create the file name using the formatted time string
    output_file = f"X06topologicalsort{time_string}.txt"
    with open(output_file, 'w') as f:
    ...
    time_string = current_time.strftime("%Y%m%d_%H%M%S")
    # Create the file name using the formatted time string
    output_file = f"X07writelabel{time_string}.txt"
    with open(output_file, 'w') as f:
